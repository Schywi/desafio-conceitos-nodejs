...
### Noções de Array
.find(): é responsavel por percorrer o array e realizar um busca.

.findIndex(): é responsavel por percorrer o array e realizar um busca e retornar o index da posição do objeto.
